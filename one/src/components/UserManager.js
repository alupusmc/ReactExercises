...
// Task 6
  ...
  constructor(props) {
    ...
    userName: "",
    loggedIn: false,
    instructions: "Please log in to the slidder",
    userIdFieldValue: "",
    passwordFieldValue: ""
    }
 ...
 this.setState({passwordFieldValue: event.target.value})
  ...
  logIn() {
    ...
    //implementacion de los estados creados,
    //uso de setState al un state existente en el constructor
    //this.setState({loggedIn: true});
    //ejemplo comentado de un setState hardcodeado
    // Task 2
    //
    // Task 3
  ...
  render() {
    // Task 2
    //if user is logged in se despliega el jsx
    //if (true) {
//se va a implemetar el estado creado
    if (this.state.loggedIn) {
        ...
        return (
          <div className="user-manager-block user-manager-block-active-background">
            ...
            type="button" value="Log Out" onClick={this.logOut} /></p>
        ...
        return (
          <div className="user-manager-block user-manager-block-inactive-background">
            <p>user ID:&nbsp;<input type="text"
             value={this.state.userIdFieldValue} onChange={this.handleUserIdChange}/>&nbsp;
            password:&nbsp;<input type="text"
            value={this.state.passwordFieldValue} onChange={this.handlePasswordChange}/>&nbsp;
